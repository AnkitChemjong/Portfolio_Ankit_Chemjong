...
<div className="relative w-full h-full flex flex-col justify-center items-center
 md:mt-10 md:right-40 right-20 ">
  ...
  shadow-2xl">
    ...
    <Image width={0} height={0} sizes="100vw" src="/image/mongo.png" alt=""  className="md:w-10 md:h-10 w-6 h-6"/>
  </div>
  ...
  shadow-2xl">
    ...
    <Image width={0} height={0} sizes="100vw" src="/image/express.png" alt=""  className="md:w-10 md:h-10 w-6 h-6"/>
  </div>
 ...
 <h1 className="md:text-base font-semibold text-xm">
    ...
    <Image width={0} height={0} sizes="100vw" src="/image/react.png" alt=""  className="md:w-10 md:h-12 w-6 h-6"/>
  </div>
  ...
  shadow-2xl">
    ...
    <Image width={0} height={0} sizes="100vw" src="/image/node.png" alt=""  className="md:w-10 md:h-10 w-6 h-6"/>
  </div>
  ...
  shadow-2xl">
    ...
    <Image width={0} height={0} sizes="100vw" src="/image/mysql.png" alt=""  className="md:w-10 md:h-10 w-6 h-6"/>
  </div>
</div>
</div>
  )
